...
func (h *PolicyHandler) ListPolicies(c *gin.Context) {
	...
	if err := database.DB.Preload("Routes").Preload("AllowedNetworks").Preload("Groups").Find(&policies).Error; err != nil {
...
func (h *PolicyHandler) GetPolicy(c *gin.Context) {
	...
	if err := database.DB.Preload("Routes").Preload("AllowedNetworks").Preload("TimeRestrictions").Preload("Groups").First(&policy, id).Error; err != nil {
